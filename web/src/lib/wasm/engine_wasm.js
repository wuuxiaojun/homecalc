 ...
 * @returns {any}
 */
export function wasm_analyze_scenario(val) {
    const ret = wasm.wasm_analyze_scenario(val);
    if (ret[2]) {
 ...
 * @returns {string}
 */
export function wasm_analyze_scenario_from_json(scenario_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(scenario_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasm_analyze_scenario_from_json(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {number}
 */
export function wasm_calculate_scenario_pv_from_json(scenario_json) {
    const ptr0 = passStringToWasm0(scenario_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.wasm_calculate_scenario_pv_from_json(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0];
 ...
 * @returns {any}
 */
export function wasm_compare_scenarios(val_a, val_b) {
    const ret = wasm.wasm_compare_scenarios(val_a, val_b);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {string} scenario_a_json
 * @param {string} scenario_b_json
 * @returns {string}
 */
export function wasm_compare_scenarios_from_json(scenario_a_json, scenario_b_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(scenario_a_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(scenario_b_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasm_compare_scenarios_from_json(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {any}
 */
export function wasm_create_scenario(val) {
    const ret = wasm.wasm_create_scenario(val);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {string} purchase_json
 * @returns {string}
 */
export function wasm_create_scenario_from_json(purchase_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(purchase_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasm_create_scenario_from_json(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {number}
 */
export function wasm_default_starting_cash() {
    const ret = wasm.wasm_default_starting_cash();
    return ret;
}
 ...
 * @param {string} cash_flows_json
 * @returns {number | undefined}
 */
export function wasm_solve_irr(cash_flows_json) {
    const ptr0 = passStringToWasm0(cash_flows_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.wasm_solve_irr(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
